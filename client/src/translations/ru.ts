export const ru = {
	...
	add_people_text: 'Хотел бы видеть кого то из ресурса gmail.com? Напишите его электронную почту нижу – и, если у нас получится, мы отправим ему письмо с приглашением от Вас',
	add_people_email_placeholder: 'Введите электронный адрес gmail.com',
	send: 'Отправить',
	create_team_modal_header: 'Создать новую команду',
	create_team_modal_text: 'Создайте возможность для своих коллег работать в одном месте, добавив их в команду. Оставайтесь на связи с @упоминаниями, сотрудничайте для совместной работы и эффективно управляйте всем со страницы профиля команды.',
	team_name: 'Название команды',
	create_team_modal_placeholder: "Как назовете свою команду?",
	scrum: 'SCRUM',
	kanban: 'Канбан',
	create_a_board: 'Создать доску',
	scrum_focuses_on_planning: 'Scrum фокусируется на планировании, разпределении и выполнении ограниченных по времени фрагментов работы, называемых Спринтами.',
	kanban_focuses_on_planning: 'Канбан фокусируется на визуализации вашего рабочего процесса и ограничении незавершенной работы, чтобы облегчить постепенные усовершенствование вашего существующего проекта',
