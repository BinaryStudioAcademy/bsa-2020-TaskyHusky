export const ru = {
	...
	title: 'Заголовок',
	for_example: 'Например: Ссылка на вемо проекта',
	...
	there_are_no_projects: 'У вас еще нет проектов, которые были начаты. Когда это произойдет, вы сможете быстро получить доступ к нужной Вам работе',
