export const ru = {
	...
	deleting_will_destroy_information: 'Удаление команды уничтожит всю связанную с ней информацию. Название команды, участники, описание, ссылки на привлеченные материалы будут удалены.',
	deleting_team_cannot_be_prevented: 'Невозможно будет предотвратить удаление команды. Вы уверены, что хотите продолжить?',
	Im_sure: 'Я уверен',
	...
	there_are_no_projects_which_have_been_started_yet: 'У вас еще нет проектов, которые были начаты. Когда это произойдет, вы сможете быстро получить доступ к нужной Вам работе',
