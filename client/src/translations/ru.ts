export const ru = {
	...
	people: 'Люди',
	people_and_teams: 'Люди и команды',
	...
	content_lang: 'Язык будет соответствующим образом изменен в каталоге.',
	del_acc: 'Удаление аккаунта',
	content_del:
		'После удаления аккаунта вы потеряете доступ к сервисам Tasky-Husky, а ваши личные данные будут безвозвратно удалены. Действуют Условия использования и Политика конфиденциальности.',
	...
	see_it: 'Смотреть!',
	mark_notif_as_read: 'Отметить как прочитанное',
	show_notifs_during_last_10_days: 'Показать все объявления за последние 10 дней',
	mark_notif_as_unread: 'Отметить как непрочитанное',
	...
	label_pick_color: 'Выберите цвет',
	result: 'Результат:',
	no_label: 'Ярлыков нет',
	delete_label: 'Удалить ярлык',
	delete_label_confirm: 'Вы действительно хотите удалить этот ярлык?',
	...
	landing_block_title_planning: 'Гибкое планирование',
	landing_block_description_planning:
		'Scrum? Есть. Kanban? Есть. TaskyHusky предоставляет множество вариантов планирования, благодаря чему ваша команда сможет создавать планы оптимальным способом.',
	landing_block_title_estimations: 'Точные оценки',
	landing_block_description_estimations:
		'Благодаря оценкам ваша команда будет работать качественнее и эффективнее. Вы можете использовать очки за истории, часы, размеры футболок или собственные методики оценки — TaskyHusky все это поддерживает.',
	landing_block_description_prioritization: 'Расстановка приоритетов на основе ценности',
	landing_block_title_prioritization:
		'Упорядочить пользовательские истории, задачи и баги в бэклоге продукта можно обычным перетаскиванием. Теперь все самое важное для клиента всегда будет наверху.',
