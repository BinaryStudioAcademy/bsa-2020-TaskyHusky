export const ua = {
	...
	add_people_text: 'Не вистачає когось із ресурсу gmail.com? Надрукуйте його електронну пошту нижче – і, якщо нас вдасться, ми надішлемо йому запрошення від Вас на пошту',
	add_people_email_placeholder: 'Введіть електронну адресу gmail.com',
	send: 'Надіслати',
	create_team_modal_header: 'Створити нову команду',
	create_team_modal_text: 'Створіть можливість для своїх колег працювати в одному місці, додавши їх до команди. Залишайтеся на зв’язку використовуючи @згадки, працюйте над спільною роботою та ефективно керуйте усім на сторінці профілю команди.',
	team_name: 'Назва команди',
	create_team_modal_placeholder: "Як ви назвете свою команду?",
	scrum: 'SCRUM',
	kanban: 'Канбан',
	create_a_board: 'Створити дошку',
	scrum_focuses_on_planning: 'Scrum фокусується на плануванні, разпределенні і виконанні обмежених за часом фрагментів роботи, які називаються Спринтами.',
	kanban_focuses_on_planning: 'Канбан зосереджується на візуалізації робочого процесу та обмеженні незавершеного виробництва для полегшення поступові вдосконалення вашого існуючого проекту',
