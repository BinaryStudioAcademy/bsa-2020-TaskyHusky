export const ua = {
	...
	deleting_will_destroy_information: 'Видалення команди знищить всю інформацію, пов’язану з нею. Ім\'я команди, учасники, опис, посилання на залучені матеріали будуть видалені.',
	...
	there_are_no_projects_which_have_been_started_yet: 'У вас ще немає проектів, які були розпочаті. Коли це станеться, ви зможете швидко отримати доступ до потрібної Вам роботи',
