export const en = {
	...
	deleting_will_destroy_information: 'Deleting the team will destroy all information related to it. The name of the team, participants, description and links to attracted materials will be deleted.',
